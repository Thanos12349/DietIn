...
const Blog = () => {
  const blogPosts = [
  { id: 1, title: "Moringa Sandwich", category: "VEG EXOTIC SALADS", image: "./images/moringa sandwich.jpg" },
  { id: 2, title: "Creamy Mushroom Sandwich", category: "VEG EXOTIC SALADS", image: "./images/creamy mushroom sandwich.jpg" },
  { id: 3, title: "Paneer Tikka Sandwich", category: "VEG EXOTIC SALADS", image: "./images/paneer tikka sandwich.jpg" },
  { id: 4, title: "Herbivore’s BlissWich (Mix Veg)", category: "VEG EXOTIC SALADS", image: "./images/herbivore’s blisswich (mix veg).jpg" },
  { id: 5, title: "Greek Goddess Bowl", category: "VEG EXOTIC SALADS", image: "./images/greek goddess bowl.jpg" },
  { id: 6, title: "Smokey Chicken Bowl", category: "NON VEG EXOTIC SALADS", image: "./images/smokey chicken bowl.jpg" },
  { id: 7, title: "Thai Curry Bowl", category: "CHINESE EXOTIC SALADS", image: "./images/thai curry bowl.jpg" },
  { id: 8, title: "Buddha Bowl", category: "VEG EXOTIC SALADS", image: "./images/buddha bowl.jpg" },
  { id: 9, title: "Teriyaki Chicken Bowl", category: "NON VEG EXOTIC SALADS", image: "./images/teriyaki chicken bowl.jpg" },
  { id: 10, title: "Teriyaki Fish Bowl", category: "NON VEG EXOTIC SALADS", image: "./images/teriyaki fish bowl.jpg" },
  { id: 11, title: "Millet Bowl", category: "VEG EXOTIC SALADS", image: "./images/millet bowl.jpg" },
  { id: 12, title: "Rajma Bowl", category: "VEG EXOTIC SALADS", image: "./images/rajma bowl.jpg" },
  { id: 13, title: "Paneer Curry Bowl", category: "VEG EXOTIC SALADS", image: "./images/paneer curry bowl.jpg" },
  { id: 14, title: "White Chana Bowl", category: "VEG EXOTIC SALADS", image: "./images/white chana bowl.jpg" },
  { id: 15, title: "Egg Curry Bowl", category: "NON VEG EXOTIC SALADS", image: "./images/egg curry bowl.jpg" },
  { id: 16, title: "Falafel Wrap", category: "Hummus", image: "./images/falafel wrap.jpg" },
  { id: 17, title: "Paneer Tikka Wrap", category: "Hummus", image: "./images/paneer tikka wrap.jpg" },
  { id: 18, title: "Chicken Tikka Wrap", category: "Hummus", image: "./images/chicken tikka wrap.jpg" },
  { id: 19, title: "Tofu Tikka Wrap", category: "Hummus", image: "./images/tofu tikka wrap.jpg" },
  { id: 20, title: "French Toast", category: "CLASSIC SALADS", image: "./images/french toast.jpg" },
  { id: 21, title: "Egg Wrap", category: "Hummus", image: "./images/egg wrap.jpg" },
  { id: 22, title: "Pindi Chole Wrap", category: "Hummus", image: "./images/pindi chole wrap.jpg" },
  { id: 23, title: "Caesar Salad", category: "CLASSIC SALADS", image: "./images/caesar salad.jpg" },
  { id: 24, title: "Creamy Quinoa Salad", category: "CLASSIC SALADS", image: "./images/creamy quinoa salad.jpg" },
  { id: 25, title: "Egg Salad", category: "NON VEG EXOTIC SALADS", image: "./images/egg salad.jpg" },
  { id: 26, title: "Chicken Tikka Salad", category: "NON VEG EXOTIC SALADS", image: "./images/chicken tikka salad.jpg" },
  { id: 27, title: "Fresh Garden Salad", category: "CLASSIC SALADS", image: "./images/fresh garden salad.jpg" },
  { id: 28, title: "Paneer Salad", category: "VEG EXOTIC SALADS", image: "./images/paneer salad.jpg" },
  ...
  { id: 49, title: "Zucchini Noodles", category: "PASTA EXOTIC SALADS", image: "./images/zucchini noodles.jpg" },
  { id: 50, title: "Buckwheat Noodles", category: "PASTA EXOTIC SALADS", image: "./images/buckwheat noodles.jpg" },
  { id: 51, title: "Wheat Noodles", category: "PASTA EXOTIC SALADS", image: "./images/wheat noodles.jpg" },
  { id: 52, title: "Chili Garlic Rice Noodles", category: "PASTA EXOTIC SALADS", image: "./images/chili garlic rice noodles.jpg" },
  { id: 53, title: "Millet Pasta (avg.)", category: "PASTA EXOTIC SALADS", image: "./images/millet pasta (avg.).jpg" },
  { id: 54, title: "Shirataki Noodles", category: "PASTA EXOTIC SALADS", image: "./images/shirataki noodles.jpg" },
  { id: 55, title: "Singapuri Wheat Noodles", category: "PASTA EXOTIC SALADS", image: "./images/singapuri wheat noodles.jpg" },
  { id: 56, title: "Green Soup", category: "CHINESE EXOTIC SALADS", image: "./images/green soup.jpg" },
  { id: 57, title: "Pumpkin Soup", category: "CHINESE EXOTIC SALADS", image: "./images/pumpkin soup.jpg" },
  { id: 58, title: "Mix Veg Soup", category: "CHINESE EXOTIC SALADS", image: "./images/mix veg soup.jpg" },
  { id: 59, title: "Chicken Soup", category: "CHINESE EXOTIC SALADS", image: "./images/chicken soup.jpg" },
  { id: 60, title: "Hot and Sour Soup", category: "CHINESE EXOTIC SALADS", image: "./images/hot and sour soup.jpg" },
  { id: 61, title: "Manchow Soup", category: "CHINESE EXOTIC SALADS", image: "./images/manchow soup.jpg" },
  { id: 62, title: "Tomato Coriander Soup", category: "CHINESE EXOTIC SALADS", image: "./images/tomato coriander soup.jpg" },
  { id: 63, title: "Lemon Coriander Soup", category: "CHINESE EXOTIC SALADS", image: "./images/lemon coriander soup.jpg" },
  { id: 64, title: "Exotic Roasted Veggies", category: "VEG EXOTIC SALADS", image: "./images/exotic roasted veggies.jpg" },
  { id: 65, title: "Gas Roasted Tomatoes", category: "VEG EXOTIC SALADS", image: "./images/gas roasted tomatoes.jpg" },
  { id: 66, title: "Paneer Tikka", category: "VEG EXOTIC SALADS", image: "./images/paneer tikka.jpg" },
  { id: 67, title: "Mushroom Tikka", category: "VEG EXOTIC SALADS", image: "./images/mushroom tikka.jpg" },
  { id: 68, title: "Roasted Chicken with Veggies", category: "NON VEG EXOTIC SALADS", image: "./images/roasted chicken with veggies.jpg" },
  { id: 69, title: "Dahi ke Kebabs", category: "VEG EXOTIC SALADS", image: "./images/dahi ke kebabs.jpg" },
  { id: 70, title: "Hara Bhara Kebabs", category: "VEG EXOTIC SALADS", image: "./images/hara bhara kebabs.jpg" },
  { id: 71, title: "Hummus and Veg Sticks", category: "Hummus", image: "./images/hummus and veg sticks.jpg" },
  { id: 72, title: "Falafel Tikki", category: "Hummus", image: "./images/falafel tikki.jpg" },
  { id: 73, title: "Ragi Idli with Sambar", category: "VEG EXOTIC SALADS", image: "./images/ragi idli with sambar.jpg" },
  { id: 74, title: "Tadka Idli", category: "VEG EXOTIC SALADS", image: "./images/tadka idli.jpg" },
  { id: 75, title: "Suji Idli with Sambar", category: "VEG EXOTIC SALADS", image: "./images/suji idli with sambar.jpg" },
  { id: 76, title: "Ragi Appe with Sambar", category: "VEG EXOTIC SALADS", image: "./images/ragi appe with sambar.jpg" },
  { id: 77, title: "Dal Vada with Sambar", category: "VEG EXOTIC SALADS", image: "./images/dal vada with sambar.jpg" },
  { id: 78, title: "Suji Uttapam", category: "VEG EXOTIC SALADS", image: "./images/suji uttapam.jpg" },
  { id: 79, title: "Moongdal Appe with Sambar", category: "VEG EXOTIC SALADS", image: "./images/moongdal appe with sambar.jpg" },
  { id: 80, title: "Moong Dal Cheela", category: "VEG EXOTIC SALADS", image: "./images/moong dal cheela.jpg" },
  ...
  const categories = [
    ...
    "Hummus",
    "VEG EXOTIC SALADS",
    "NON VEG EXOTIC SALADS",
    "PASTA EXOTIC SALADS",
    "CHINESE EXOTIC SALADS",
    "CLASSIC SALADS"
  ];
